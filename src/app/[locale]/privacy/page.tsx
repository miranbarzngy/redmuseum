      ...
      <ScrollExperience>
        <main className="flex min-h-screen flex-col justify-center py-32">
          <div className="container-art section-px max-w-3xl">
            <h1 className="font-display text-fluid-2xl font-semibold text-ink">{t("privacyTitle")}</h1>
            <p className="mt-6 text-fluid-sm leading-relaxed text-ink-soft">{t("privacyBody")}</p>
          </div>
        </main>
        <Footer />
      </ScrollExperience>
