 ...
 * (leading "+", thousands grouping) at any point during the animation.
 * Always renders Western digits, regardless of locale. Returns null for
 * non-numeric admin input, which just renders as static text instead of
 * animating.
 */
