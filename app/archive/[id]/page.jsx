...
export default function EnglishArchiveDetail() {
  ...
  useEffect(() => {
    if (item) {
      document.title = item.title_en || item.title_ku || 'Archive Item'
    }
  }, [item])
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">The requested archive item could not be found.</p>
          <Link
            href="/archive"
          ...
          <div className="bg-gray-800 rounded-xl overflow-hidden shadow-2xl mb-8">
            <div className="relative w-full h-[300px] md:h-[500px] lg:h-[600px] flex items-center justify-center bg-zinc-900/50 p-4">
              <img
                ...
                alt={item.title_en || item.title_ku}
          ...
          <div className="bg-gray-800 rounded-xl p-6 md:p-8">
            ...
            {item.description_ku && (
              <div className="mb-6 pt-6 border-t border-gray-700">
                <h3 className="text-lg font-semibold text-gray-400 mb-2" style={{ fontFamily: 'UniSalar, Tahoma, sans-serif' }} dir="rtl">
                  کوردی:
                </h3>
                <p className="text-gray-300 leading-relaxed whitespace-pre-wrap" style={{ fontFamily: 'UniSalar, Tahoma, sans-serif' }} dir="rtl">
                  {item.description_ku}
                </p>
              </div>
            )}
