    ...
    <div className="max-w-6xl space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <span className="w-11 h-11 rounded-2xl bg-gradient-to-br from-yellow-600 to-amber-700 flex items-center justify-center shadow-lg shadow-amber-950/40">
            <Crown size={20} strokeWidth={1.8} className="text-white" />
          </span>
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Exclusive Events</h1>
            <p className="text-sm text-gray-400 mt-0.5">Landscape images (16:9) · Best size: 1920×1080px · Max 10 MB</p>
          </div>
          {saving && (
