      ...
      <div className="relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #2a0000 0%, #0a0a0a 100%)' }}>
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="mt-8 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm"
            style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(200,169,110,0.15)', color: '#9ca3af', ...KU }}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5">
            {filteredItems.map(item => (
              ...
              >
                ...
                {/* Image — natural proportions, no crop */}
                ...
                <div className="p-4 flex flex-col gap-1.5 flex-1">
                  ...
                  {(item.description_ku || item.description_en) && (
                    <p className="text-xs text-white/60 line-clamp-2 leading-relaxed" style={KU}>
                      {item.description_ku || item.description_en}
                    </p>
                  )}
                  {/* Arrow */}
