    ...
    <div>
      ...
      {type === 'textarea' ? (
        ...
        <input
          ...
          value={form[key]}
          onChange={e => setForm(p => ({ ...p, [key]: e.target.value }))}
          className={`w-full px-4 py-3 bg-white/5 border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-red-500 transition-colors ${errors[key] ? 'border-red-500 bg-red-500/5' : 'border-white/10'}`}
          style={{ fontFamily: fontStyle(lang) }}
          {...extra}
        />
      )}
    ...
    >
      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="text-center mb-10">
          <Link href={`/${lang === 'ar' ? 'arabic' : 'kurdish'}`} className="inline-flex items-center gap-2 text-gray-400 hover:text-white text-sm mb-8 transition-colors">
